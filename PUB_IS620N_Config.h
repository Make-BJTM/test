/*******************************************************************************
 ...
 修改记录：  
    ...
    1. xxxx
********************************************************************************/ 
#ifndef __PUB_IS620N_CONFIG_H
#define __PUB_IS620N_CONFIG_H
...
//标准软件通用版本号Y.A
#define VERSION_STANDARD        35

//H0100 DSP软件通用版本号
#define VERSION_H0100         ((1 * 1000) + VERSION_STANDARD)
...
//非标号
#define NONSTANDARD_PROJECT    0x710

//非标软件版本号
#if NONSTANDARD_PROJECT != 0
    #define VERSION_NONSTANDARD     0x28 
#else
